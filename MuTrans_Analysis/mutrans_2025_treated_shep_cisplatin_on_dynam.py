## MuTrans treated samples: SH-EP Off
## February 2025
...
filename = "shep_cisplatin_on_scanpy_nn.h5ad"
...
k = 3
par = {"choice_distance":"cosine", "K_cluster":k, "trials":50, "weight_scale":True, "initial":"pca", "fig_name": f"{plotdir}{sample_name}_dynam_out"} 
...
sc.pl.violin(adata_mu, keys = ['VIM','PHOX2B','GATA2','PRRX1','CD24','CD44','SOX6','SOX11'], groupby = 'attractor', palette = color_palette, size = 0, show = False)
