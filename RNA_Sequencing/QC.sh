...
cd /data/scratch/DMP/DUDMP/PAEDCANC/asadr/BulkRNAseq/rawdata/clean

# Running FASTQC
module load FastQC/0.11.9
mkdir -p fastqc
# Find all of the fastq files
find /data/scratch/DMP/DUDMP/PAEDCANC/asadr/BulkRNAseq/rawdata/clean -name "*.gz" -exec fastqc -o fastqc/ {} \;

# run multiqc to compile individual fastqc files, this helps visualization of fastqc reports
conda activate multiqc1.9
#mkdir -p multiqc
multiqc /data/scratch/DMP/DUDMP/PAEDCANC/asadr/BulkRNAseq/rawdata/clean/fastqc/ -o multiqc
