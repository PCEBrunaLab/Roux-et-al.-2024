...
# Paths
SCRATCH_DIR=/data/scratch/DMP/DUDMP/PAEDCANC/asadr/WES/BWA
Picard=/data/scratch/DMP/DUDMP/PAEDCANC/asadr/WES/Picard_output
...
for BAM_FILE in $SCRATCH_DIR/*.bam; do
