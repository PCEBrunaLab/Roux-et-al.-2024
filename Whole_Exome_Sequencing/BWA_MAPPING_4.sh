...
PARENT_DIR=/data/scratch/DMP/DUDMP/PAEDCANC/asadr/WES/MERGED_WES
...
for DIR in $PARENT_DIR/*; do
  if [ -d "$DIR" ]; then
    ...
    PREFIX=/data/scratch/DMP/DUDMP/PAEDCANC/asadr/WES/BWA${BASENAME}  # BWA outputs will be written here
